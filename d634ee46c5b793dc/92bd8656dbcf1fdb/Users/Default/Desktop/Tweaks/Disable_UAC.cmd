...
Reg Add "HKLM\WIM_Software\Microsoft\Windows\CurrentVersion\Policies\System" /v "EnableLUA" /t REG_DWORD /d "0x0" /f
Reg Add "HKLM\WIM_System\ControlSet001\Services\luafv" /v "Start" /t REG_DWORD /d "4" /f
